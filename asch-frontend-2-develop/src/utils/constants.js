...
const urls = {
  ...
  serverUrl: '',
  // 区分 local 与 mainnet 的请求头参数// '5f5b3cf5',// 594fe0f3
  magic: '594fe0f3',
  // 登录接
  loginApi: {
  ...
  v2: {
    ...
    // 获取理事会成员--新
    councilMemberApi: {
      url: '/api/v2/council/getcouncil'
    },
    // 获取理事会投票--
    councilVotes: {
      url: '/api/v2/council/getVotes'
    },
    // 获取理事会列表
    councils: {
      url: '/api/v2/groups'
...
const transTypes = {
  ...
  700: 'TRS_TYPE_COUNCIL_ADD',
  701: 'TRS_TYPE_COUNCIL_VOTECOUN',
  702: 'TRS_TYPE_COUNCIL_TRANS',
  703: 'TRS_TYPE_COUNCIL_TRANSVOTE',
  704: 'TRS_TYPE_COUNCIL_REMOVE',
  705: 'TRS_TYPE_COUNCIL_VOTEDELETE'
